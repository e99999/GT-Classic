...
public class GTRecipeAlloySmelter {
	...
	public static void recipesAlloySmelter1() {
		...
		GTTileAlloySmelter.addRecipe("sand", 5, GT.get(GTItems.moldTube), GT.get(GTItems.testTube, 32));
		GTTileAlloySmelter.addRecipe("blockGlass", 5, GT.get(GTItems.moldTube), GT.get(GTItems.testTube, 32));

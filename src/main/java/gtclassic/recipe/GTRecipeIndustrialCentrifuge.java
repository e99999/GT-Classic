...
public class GTRecipeIndustrialCentrifuge {
	...
	public static void recipesCentrifuge1() {
		...
		GTTileIndustrialCentrifuge.addRecipe("oreBasalt", 12, 0, euCost(15000),
				new OutputItem(GT.getDust(M.Basalt, 9), 0), new OutputItem(GT.getDust(M.GarnetRed, 1), 1),
				new OutputItem(GT.getDust(M.GarnetYellow, 1), 2), new OutputItem(GT.getDust(M.Zirconium, 1), 3));
	...
	public static void recipesCentrifuge2() {
		...
		GTTileIndustrialCentrifuge.addRecipe(GT.get(Items.ROTTEN_FLESH, 16), 1, euCost(25000),
				new OutputItem(GT.getFluid(M.Methane, 1), 0), new OutputItem(GT.get(Items.LEATHER, 6), 1),

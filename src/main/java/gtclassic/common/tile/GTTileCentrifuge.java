...
public class GTTileCentrifuge extends GTTileBaseMachine {
	...
	public static void init() {
		...
		addRecipe("stoneMarble", 8, 0, totalEu(6000), GTMaterialGen.getDust(GTMaterial.Magnesium, 1), GTMaterialGen.getDust(GTMaterial.Calcite, 7));
		...
		addRecipe("dustObsidian", 8, 6, totalEu(5000), GTMaterialGen.getDust(GTMaterial.Magnesium, 1), GTMaterialGen.getIc2(Ic2Items.ironDust, 1), GTMaterialGen.getDust(GTMaterial.Silicon, 2), GTMaterialGen.getTube(GTMaterial.Oxygen, 4));

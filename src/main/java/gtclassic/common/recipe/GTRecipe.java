...
public class GTRecipe {
	...
	public static void initBlocks() {
		if (!Loader.isModLoaded(GTHelperMods.GTCX)) {
			...
			/** Pipelines **/
			recipes.addRecipe(GTMaterialGen.get(GTBlocks.pipelineItem, 4), "III", "PMP", "III", 'P', anyPiston, 'I', "ingotElectrum", 'M', "machineBlockBasic");
			recipes.addRecipe(GTMaterialGen.get(GTBlocks.pipelineFluid, 4), "III", "BMB", "III", 'B', Items.BUCKET, 'I', "ingotAluminium", 'M', "machineBlockBasic");
			recipes.addRecipe(GTMaterialGen.get(GTBlocks.tilePipelineItemEnd, 1), "PIP", "IMI", "PIP", 'P', anyPiston, 'I', "ingotPlatinum", 'M', "machineBlockBasic");
			recipes.addRecipe(GTMaterialGen.get(GTBlocks.tilePipelineFluidEnd, 1), "BIB", "IMI", "BIB", 'B', Items.BUCKET, 'I', "ingotTungsten", 'M', "machineBlockBasic");
		}

...
public class GTSluiceBoxModel extends BaseModel {
	...
	public void init() {
		...
		// bottom main part
		baker.addModel(0, 40, 1, 0, 0, 14, 1, 16);
		// bottom sides
		baker.addModel(0, 18, 0, 0, 0, 1, 6, 16);
		baker.addModel(0, 18, 15, 0, 0, 1, 6, 16);
		// stripes
		baker.addModel(0, 59, 1, 1, 2, 14, 1, 1);
		baker.addModel(0, 59, 1, 1, 6, 14, 1, 1);
		// top main part
		baker.addModel(0, 0, 0, 6, 4, 16, 1, 12);
		// top long sides
		baker.addModel(12, 11, 1, 7, 4, 14, 6, 1);
		baker.addModel(12, 11, 1, 7, 15, 14, 6, 1);
		// top short sides
		baker.addModel(0, 0, 0, 7, 4, 1, 6, 12);
		baker.addModel(7, 0, 15, 7, 4, 1, 6, 12);

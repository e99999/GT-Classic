...
public class GTContainerArcFurnace extends ContainerTileComponent<GTTileMultiArcFurnace> {
	...
	public GTContainerArcFurnace(InventoryPlayer player, GTTileMultiArcFurnace tile) {
		super(tile);

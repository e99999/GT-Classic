...
public class GTContainerLESU extends ContainerTileComponent<GTTileEntityLESU> {
	...
	public GTContainerLESU(InventoryPlayer player, GTTileEntityLESU tile) {
		...
		this.addComponent(
				new GTGuiCompEnergyBar(tile, GTContainerLESU.chargeProgressBox, GTContainerLESU.chargeProgressPos));

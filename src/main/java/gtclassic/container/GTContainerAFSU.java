...
public class GTContainerAFSU extends ContainerTileComponent<GTTileAFSU> {
	...
	public GTContainerAFSU(InventoryPlayer player, GTTileAFSU tile) {
		super(tile);
		...
		this.addComponent(new GTGuiCompEnergyStorageBar(tile, GTContainerAFSU.chargeProgressBox, GTContainerAFSU.chargeProgressPos));

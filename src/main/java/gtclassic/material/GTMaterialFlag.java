...
public class GTMaterialFlag {
	...
	public static GTMaterialFlag DUST = new GTMaterialFlag("_dust", 0, false),
			...
			GAS = new GTMaterialFlag("", 13, true), MOLTEN = new GTMaterialFlag("", 13, true),
			BLOCKMETAL = new GTMaterialFlag("_block", 16, false), BLOCKGEM = new GTMaterialFlag("_block", 17, false);

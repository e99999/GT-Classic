...
public class GTBlockTileCustom extends BlockMultiID implements IBlockTextureModifier {
	...
	public enum GTBlockTileCustomVariants {
		...
		BATTERY_LARGE_LITHIUM(10, 11),
		BATTERY_MED_ENERGIUM(11, 11), 
		BATTERY_MED_LAPOTRON(11, 11), 
		BATTERY_MED_LITHIUM(8, 11),
		BATTERY_SMALL_ENERGIUM(6, 6), 
		BATTERY_SMALL_LAPOTRON(6, 6), 
		BATTERY_SMALL_LITHIUM(6, 11), 
		CIRCUIT_DATA(16, 1),
		CIRCUIT_ENERGY(16, 1), 
		COOLANT_LARGE_HELIUM(13, 2), 
		COOLANT_MED_HELIUM(13, 2), 
		COOLANT_SMALL_HELIUM(5, 13),
		...
		ROD_LARGE_PLUTONIUM(7, 16),
		ROD_LARGE_THORIUM(7, 16), 
		ROD_MED_PLUTONIUM(6, 16), 

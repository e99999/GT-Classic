...
import gtclassic.itemblock.GTItemBlockResinBottle;
...
public class GTBlockResinBottle extends GTBlockTileCustom implements GTItemBlockInterface {

	public int damage = 7;

	public GTBlockResinBottle(String name, int width, int height, boolean light) {
		super(name, width, height, light);
	}

	@Override
	public Class<? extends ItemBlockRare> getCustomItemBlock() {
		return GTItemBlockResinBottle.class;
	}

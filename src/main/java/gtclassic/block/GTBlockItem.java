...
public class GTBlockItem extends BlockCommonContainer implements IBlockTextureModifier {
	...
	public enum GTBlockItemVariants {
		SMALL_COOLANT(32, 32, GTValues.SMALLCOOLANT_AABB), MED_COOLANT(32, 32, GTValues.LARGECOOLANT_AABB),
		LARGE_COOLANT(32, 32, GTValues.LARGECOOLANT_AABB),

		SMALL_THORIUM(32, 32, GTValues.SMALLROD_AABB), MED_THORIUM(32, 32, GTValues.MEDROD_AABB),
		LARGE_THORIUM(32, 32, GTValues.LARGEROD_AABB),

		SMALL_PLUTONIUM(32, 32, GTValues.SMALLROD_AABB), MED_PLUTONIUM(32, 32, GTValues.MEDROD_AABB),
		LARGE_PLUTONIUM(32, 32, GTValues.LARGEROD_AABB),

		SMALL_LITHIUM(16, 16, GTValues.SLIMBATTERY_AABB), MED_LITHIUM(16, 16, GTValues.MEDBATTERY_AABB),
		LARGE_LITHIUM(16, 16, GTValues.LARGEBATTERY_AABB),

		SMALL_LAPOTRON(17, 17, GTValues.SMALLBATTERY_AABB), MED_LAPOTRON(17, 17, GTValues.MEDBATTERY_AABB),
		LARGE_LAPOTRON(17, 17, GTValues.LARGEBATTERY_AABB),

		SMALL_ENERGIUM(18, 18, GTValues.SMALLBATTERY_AABB), MED_ENERGIUM(18, 18, GTValues.MEDBATTERY_AABB),
		LARGE_ENERGIUM(18, 18, GTValues.LARGEBATTERY_AABB),

		ALUMINIUM_DATASTICK(32, 35, GTValues.DATASTICK_AABB), TITANIUM_DATASTICK(32, 36, GTValues.DATASTICK_AABB),
		CHROME_DATASTICK(32, 37, GTValues.DATASTICK_AABB),

		ALUMINIUM_DATADRIVE(32, 38, GTValues.DATADRIVE_AABB), TITANIUM_DATADRIVE(32, 39, GTValues.DATADRIVE_AABB),
		CHROME_DATADRIVE(32, 40, GTValues.DATADRIVE_AABB),

		ENERGY_CIRCUIT(33, 32, GTValues.CIRCUIT_AABB), DATA_CIRCUIT(34, 32, GTValues.CIRCUIT_AABB);

...
public class GTBlockOre extends Block implements ILayeredBlockModel {
	public enum GTBlockOreVariants {

		GALENA(96, 1, 3.0F), IRIDIUM(97, 3, 20.0F), RUBY(98, 2, 4.0F), SAPPHIRE(99, 2, 4.0F), BAUXITE(100, 1, 3.0F),
		PYRITE(102, 1, 2.0F), CINNABAR(103, 2, 3.0F), SPHALERITE(104, 1, 2.0F), TUNGSTATE(105, 2, 4.0F),
		SHELDONITE(106, 3, 3.5F), OLIVINE(107, 3, 3.0F), SODALITE(108, 2, 3.0F);
	...
	public TextureAtlasSprite getLayerTexture(IBlockState state, EnumFacing facing, int layer) {
		...
		// 0-2
		return Ic2Icons.getTextures(GTMod.MODID + "_blocks")[17 + layer];
	}

	@Override
	public TextureAtlasSprite getTextureFromState(IBlockState state, EnumFacing facing) {
		// back up texture for particles and shit

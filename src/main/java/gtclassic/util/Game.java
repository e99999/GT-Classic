...
/*-------------------------------------------------------------------------
*--------------------------------------------------------------------------
*This whole class was copied from Railcraft and therefore is their property.
...
public final class Game {
    ...
    static {
        ...
        DEVELOPMENT_ENVIRONMENT = GTClassic.getVersion().matches(".*(alpha|beta).*") || !OBFUSCATED;
    ...
    public static void log(Level level, Message msg) {
        LogManager.getLogger(GTClassic.MODID).log(level, msg);
    }

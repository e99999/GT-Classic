...
public abstract class GTTileFuelBaseMachine extends TileEntityMachine implements ITickable, IFuelMachine, IProgressMachine, IHasGui, INetworkTileEntityEventListener {
    @NetworkField(
            index = 3
    )
    public int fuel = 0;

...
public class GTValues {
	...
	public static final String MOD_ID_BUILDCRAFT = "buildcraftbuilders", MOD_ID_FORESTRY = "forestry",
			...
			MOD_ID_FASTLEAF = "fastleafdecay", MOD_ID_RC = "railcraft", MOD_ID_CT = "crafttweaker";
	...
	public static final IRecipeInput INPUT_INGOT_MACHINE = GTRecipeCraftingHandler.combineRecipeObjects(INGOT_REFINEDIRON, INGOT_ALUMINIUM),
			...
			INPUT_INGOT_MAGIC = GTRecipeCraftingHandler.combineRecipeObjects(INGOT_PLATINUM, "ingotDraconium", "ingotKnightmetal", "ingotThaumium", "ingotManasteel", "ingotStarmetal", "ingotSyrmorite"),

...
public class GTMaterial {
	...
	static GTMaterialFlag pipeItem = GTMaterialFlag.PIPEITEM;
	static GTMaterialFlag pipeFluid = GTMaterialFlag.PIPEFLUID;
	...
	static GTMaterialFlag[] pipeItemAll = { dust, ingot, blockMetal, pipeItem };
	static GTMaterialFlag[] pipeFluidAll = { dust, ingot, blockMetal, pipeFluid };
	/** Master Material Map **/
	...
	public static final GTMaterial Bronze = new GTMaterial("Bronze", 1, 255, 128, 0, pipeFluid);
	...
	public static final GTMaterial HighPressure = new GTMaterial("HighPressure", Integer.MAX_VALUE, 255, 0, 0, pipeFluid);

...
public enum GTOreRegistry {
	BAUXITE(0, GTMaterial.Bauxite, 32, 2, 40, 100), BISMUTHTINE(1, GTMaterial.Bismuthtine, Blocks.SAND, 8, 8, 50, 80),
	CALCITE(2, GTMaterial.Calcite, 8, 12, 20, 80), CASSITERITE(3, GTMaterial.Cassiterite, Blocks.SAND, 32, 2, 60, 120),
	...
	LIMONITE(12, GTMaterial.Limonite, 8, 8, 40, 80), MAGNETITE(13, GTMaterial.Magnetite, Blocks.SAND, 32, 1, 60, 120),
	...
	TUNGSTATE(26, GTMaterial.Tungstate, 4, 4, 0, 16), BASALT(27, GTMaterial.Basalt, Blocks.GRAVEL, 24, 2, 16, 50),

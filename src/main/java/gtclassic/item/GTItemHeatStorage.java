...
public class GTItemHeatStorage extends ItemReactorHeatStorageBase implements IStaticTexturedItem {
	...
	public GTItemHeatStorage(GTItemHeatStorageTypes variant) {

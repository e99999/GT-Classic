...
public class GTTileCentrifuge extends GTTileBaseMachine {
	...
	public static void init() {
		...
		addRecipe("dustObsidian", 8, 6, totalEu(5000), GTMaterialGen.getDust(GTMaterial.Sodalite, 1), GTMaterialGen.getIc2(Ic2Items.ironDust, 1), GTMaterialGen.getDust(GTMaterial.Silicon, 2), GTMaterialGen.getTube(GTMaterial.Oxygen, 4));
		...
		addRecipe("dustPlatinum", 9, 0, totalEu(135000), GTMaterialGen.getDust(GTMaterial.Iridium, 1));

...
//		addRecipe("logRubber", 16, 4, totalEu(25000), GTMaterialGen.getIc2(Ic2Items.d, 8), GTMaterialGen.getIc2(Ic2Items.stickyResin, 8), GTMaterialGen.getIc2(Ic2Items.plantBall, 6), GTMaterialGen.getFluid(GTMaterial.Methane, 4));
...
//		addRecipe("dustUranium", 4, 0, totalEu(250000), GTMaterialGen.getDust(GTMaterial.Tungstate, 1), GTMaterialGen.getIc2(Ic2Items.reactorUraniumRodSingle, 4), GTMaterialGen.getDust(GTMaterial.Plutonium, 1), GTMaterialGen.getDust(GTMaterial.Thorium, 2));
...
//		addRecipe("dustBrass", 1, 0, totalEu(7500), GTMaterialGen.getDust(GTMaterial.Copper, 3), GTMaterialGen.getDust(GTMaterial.Zinc, 1));
//		addRecipe("dustBronze", 2, 0, totalEu(7500), GTMaterialGen.getDust(GTMaterial.Copper, 6), GTMaterialGen.getDust(GTMaterial.Tin, 2));
...
//		addRecipe("dustElectrum", 2, 0, totalEu(5000), GTMaterialGen.getDust(GTMaterial.Gold, 2), GTMaterialGen.getDust(GTMaterial.Silver, 2));
//		addRecipe("dustInvar", 2, 0, totalEu(5000), GTMaterialGen.getIc2(Ic2Items.ironDust, 2), GTMaterialGen.getDust(GTMaterial.Nickel, 1));
//		addRecipe("gemLapis", 4, 0, totalEu(7500), GTMaterialGen.getDust(GTMaterial.Sodalite, 2), GTMaterialGen.getDust(GTMaterial.Lazurite, 3), GTMaterialGen.getDust(GTMaterial.Pyrite, 1), GTMaterialGen.getDust(GTMaterial.Calcite, 1));
...
//		addRecipe("dustPlatinumGroupSludge", 1, 0, totalEu(2500), GTMaterialGen.getDust(GTMaterial.Iridium, 1), GTMaterialGen.getDust(GTMaterial.Osmium, 1), GTMaterialGen.getDust(GTMaterial.Platinum, 2));

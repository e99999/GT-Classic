...
public class GTItems {
	...
	public static final GTItemReactorRod rodThorium1 = createItem(new GTItemReactorRod("thorium_single", 16));
	public static final GTItemReactorRod rodThorium2 = createItem(new GTItemReactorRod("thorium_double", 17));
	public static final GTItemReactorRod rodThorium4 = createItem(new GTItemReactorRod("thorium_quad", 18));
	public static final GTItemReactorRod rodPlutonium1 = createItem(new GTItemReactorRod("plutonium_single", 19));
	public static final GTItemReactorRod rodPlutonium2 = createItem(new GTItemReactorRod("plutonium_double", 20));
	public static final GTItemReactorRod rodPlutonium4 = createItem(new GTItemReactorRod("plutonium_quad", 21));

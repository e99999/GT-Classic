...
public class GTWorldGenFluidSphere extends WorldGenerator {

	private final Block block;
	private final int startRadius;

	public GTWorldGenFluidSphere(Block blockIn, int startRadiusIn) {
		super(false);
		this.block = blockIn;
	...
	public boolean generate(World worldIn, Random rand, BlockPos position) {
		while (true) {
			label50: {
				...
				GTHelperWorld.notifyPlayersOfGeneration(worldIn, position, "FluidOrb", block.getLocalizedName());
				return true;
			}

...
public class GTBlocks {
	...
	driedLithiumChloride = registerBlock(new GTBlockCustom("Brine", 22, 16, 2));
	...
	fluidBrine = registerBlock(new GTFluidBlockDryable(GTMaterial.Brine, GTBlocks.driedLithiumChloride));
	// @formatter:on

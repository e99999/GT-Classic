...
public class GTConfig {
    ...
    private static void initGeneralConfig(Configuration cfg) {
        ...
        compatSecretProject = cfg.getBoolean("compatSecretProject", CATEGORY_GENERAL, compatSecretProject, "Enables Secret Project Compat");
        compatSuperTech = cfg.getBoolean("compatSuperTech", CATEGORY_GENERAL, compatSecretProject, "Enables Super Tech Compat");
    }
    ...
    private static void initDimensionConfig(Configuration cfg) {
        ...
        dimensionId = cfg.getInt("dimensionId", CATEGORY_TOXICDIM, dimensionId, -1000, 1000, "The Id to use for the toxic dimension");

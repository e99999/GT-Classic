...
public class GTElement {
	...
	public static final GTElement beryllium = addElement(4, GTMaterialGen.getFluid(GTMaterial.Beryllium, 1));
	public static final GTElement calcium = addElement(20, GTMaterialGen.getFluid(GTMaterial.Calcium, 1));
	public static final GTElement carbon = addElement(6, "dustCarbon", 1, GTMaterialGen.getDust(GTMaterial.Carbon, 1));
	public static final GTElement chlorine = addElement(17, GTMaterialGen.getFluid(GTMaterial.Chlorine, 1));
	public static final GTElement chrome = addElement(24, "dustChrome", 1, GTMaterialGen.getDust(GTMaterial.Chrome, 1));
	public static final GTElement helium = addElement(2, GTMaterialGen.getFluid(GTMaterial.Helium, 1));
	public static final GTElement hydrogen = addElement(1, GTMaterialGen.getFluid(GTMaterial.Hydrogen, 1));
	...
	public static final GTElement mercury = addElement(88, GTMaterialGen.getFluid(GTMaterial.Mercury, 1));
	public static final GTElement nitrogen = addElement(7, GTMaterialGen.getFluid(GTMaterial.Nitrogen, 1));
	public static final GTElement oxygen = addElement(8, GTMaterialGen.getFluid(GTMaterial.Oxygen, 1));
	public static final GTElement potassium = addElement(19, GTMaterialGen.getFluid(GTMaterial.Potassium, 1));
	public static final GTElement silicon = addElement(14, "dustSilicon", 1, GTMaterialGen.getDust(GTMaterial.Silicon, 1));
	public static final GTElement sodium = addElement(11, GTMaterialGen.getFluid(GTMaterial.Sodium, 1));
